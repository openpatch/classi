...
class _LessonModeScreenState extends ConsumerState<LessonModeScreen> {
  ...
  Future<void> _showStudentNotes({
    ...
    return showModalBottomSheet<void>(
      ...
      useSafeArea: true,
      showDragHandle: true,
      builder: (sheetContext) => _LessonStudentNotesSheet(
        groupId: group.id,
        selectedDate: _selectedDate,
        student: student,
        students: students,
                ...
                SurfaceListTile(
                  ...
                  subtitle: Padding(
                    ...
                    child: Wrap(
                      ...
                      children: [
                        if (formatLessonNoteTime(context, note.createdAt)
...
class _LessonStudentsTable extends StatelessWidget {
  const _LessonStudentsTable({
    required this.students,
...
class _LessonStudentNotesSheet extends ConsumerWidget {
  const _LessonStudentNotesSheet({
    required this.groupId,
...
String? formatLessonNoteTime(BuildContext context, DateTime createdAt) {
